                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.store') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="bg-red text-white">{{ $errors->first('release_date') }}</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="bg-red text-white">{{ $errors->first('casts') }}</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="bg-red text-white">{{ $errors->first('short_about') }}</div>
                        </div>
                        <div class="form-group">
                            <label for="about">About</label>
                            <input type="text" class="form-control" id="about" name="about"
                                value="{{ old('about') }}" placeholder="Awesome Movie">
                            <div class="bg-red text-white">{{ $errors->first('about') }}</div>
                        </div>
                        <div class="form-group">
